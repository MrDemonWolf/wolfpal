<template>
  ...
  >
    ...
    >
      <div class="p-6">
        <h2 class="text-lg font-medium leading-6 text-gray-900">Free Trial</h2>
        <p class="mt-4 text-sm text-gray-500">
          Get access to the full experience
          <span class="font-bold">no credit card needed</span>.
        </p>
        <p class="mt-8">
          <span class="text-4xl font-extrabold text-gray-900">$0.00</span>
        </p>
        <a
          href="#top"
      ...
      <div class="px-6 pt-6 pb-8">
        ...
        <ul class="mt-6 space-y-4">
          <li class="flex space-x-3">
            ...
            <span class="text-sm text-gray-500">Create Weekly Goals</span>
          </li>
          ...
          <li class="flex space-x-3">
            ...
            <span class="text-sm text-gray-500"
              >All features in Pro for <span class="font-bold">30 days </span>
            </span>
          </li>
        </ul>
      </div>
    ...
    <div
      class="border border-gray-200 divide-y divide-gray-200 rounded-lg shadow-sm bg-primary-100"
    >
      <div class="p-6">
        <h2 class="text-lg font-medium leading-6 text-gray-900">Pro</h2>
        <p class="mt-4 text-sm text-gray-500">
          Fully keep track of your goals in life.
        </p>
        <p class="mt-8">
          <span class="text-4xl font-extrabold text-gray-900">$6.99</span>
          <span class="text-base font-medium text-gray-500">/mo</span>
        </p>
        <a
          href="#"
          class="block w-full py-2 mt-8 text-sm font-semibold text-center text-white border rounded-md bg-primary-800 border-primary-800 hover:bg-primary-900"
          >Buy Pro</a
        >
      </div>
      <div class="px-6 pt-6 pb-8">
    ...
    >
      <div class="p-6">
        ...
        <p class="mt-4 text-sm text-gray-500">
          All the basics for your team.
          <span class="text-gray-400 font-sm">(Requires 5+ users)</span>
        </p>
        <p class="mt-8">
