<template>
  ...
  >
    <PricingCard
      ...
      :features="pro"
      cta="Go Pro"
      cta-link="/register/pro?frequency=yearly"
    />
    <PricingCard
      name="Free Trial"
    ...
    <PricingCard
      ...
      cta-link="/register/enterprise?frequency=yearly"
    />
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      free: ['Weekly Goals (10 max)'],
      enterprise: ['Weekly Goals', 'Two Factor', 'Notifications'],
    }
  },
}
</script>
